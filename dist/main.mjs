...
const cppCounterPid = await spawn(cppCounter.on_init, cppCounter.on_msg);
...
const rustCounterPid = await spawn(rustCounterModule.on_init, rustCounterModule.on_msg);
